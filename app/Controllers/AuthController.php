...
{
    protected $helper = ['url','form','CIMail'];
            ...
            $isValid = $this->validate([
                'login_id'=>[
                    ...
                    'errors'=>[
                        ...
                        'is_not_unique'=> 'Email is not exists in pur system.'
                    ]
                ],
                'password'=>[
    ...
    public function sendPasswordResetLink() {
        ...
        if( !$isValid ) {
            ...
            $mail_body = $view->setVar('mail_data', $email_data)->render('email-templates/forgot-email-template');
